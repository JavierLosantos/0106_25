...
class HomeController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        $rules = [
            ...
            'tipo_alimentacion' => 'required|string|max:50',
            'deportista' => 'required|in:0,1',
            'password' => 'nullable|string|min:6|confirmed', // se requiere que tenga campo password_confirmation
        ];
        ...
        if (auth()->user()->role == 'Admin') {
            ...
            return redirect()->route('users.profile', ['id' => $usuario->id])->with('success', 'Usuario actualizado correctamente');
