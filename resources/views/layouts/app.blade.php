...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img  class="brand-image img-circle elevation-3 animation__shake" src="{{url('assets/dist/img/AdminLTELogo.webp')}}" alt="AdminLTELogo" height="100" width="100">
  </div>
...
.brand-image {
    margin-right: 10x; /* Ajusta esto según sea necesario */
}
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{ url('dashboard') }}" class="brand-link">
      <img src="{{ url('assets/images/logo-aire.png') }}" alt="Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
